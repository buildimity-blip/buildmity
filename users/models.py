...
class Service(models.Model):
    ...
    def provider_count(self):
        return self.providers.filter(role='provider').count()
...
class User(AbstractUser):
    ...
    # Change from ForeignKey to ManyToMany for multiple services
    ...
    def get_services_list(self):
        """Return comma-separated list of services"""
